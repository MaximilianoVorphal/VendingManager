...
public class CajaShellTests : TestContext
{
    ...
    [Fact]
    public void Caja_Form_HasReducedOpacityWhenLocked()
    {
        ...
        cut.Markup.Should().Contain("opacity:0.45") // VmButton disabled opacity
            .And.Contain("opacity-50");              // Form card locked state
    }
